  ...
  return (
    <form ref={formRef} action={formAction}>
      {state.error ? (
        <div
          role="alert"
          className="mb-6 rounded-2xl border border-accent/25 bg-accent/10 px-4 py-3 text-sm font-semibold text-accent"
        >
          {state.error}
        </div>
      ) : null}
            ...
            <div className="mt-6 space-y-5">
              <label className="group block">
                ...
                <input
                  ...
                  className="mt-2 h-12 w-full rounded-xl border border-border bg-muted px-4 text-sm outline-none transition-colors placeholder:text-muted-foreground/60 hover:border-border-strong hover:bg-card focus:border-primary focus:bg-card focus:ring-4 focus:ring-primary/10"
                />
              ...
              <label className="group block">
                ...
                <div className="mt-2 flex min-w-0 rounded-xl border border-border bg-muted transition-colors hover:border-border-strong focus-within:border-primary focus-within:bg-card focus-within:ring-4 focus-within:ring-primary/10">
              ...
              <div className="group">
                ...
                <textarea
                  ...
                  className="mt-2 w-full resize-y rounded-xl border border-border bg-muted px-4 py-3 text-sm leading-6 outline-none transition-colors placeholder:text-muted-foreground/60 hover:border-border-strong hover:bg-card focus:border-primary focus:bg-card focus:ring-4 focus:ring-primary/10"
                />
            ...
            {imagePreview ? (
              <div className="mt-6">
                <div
                  ...
                  className="group relative aspect-video overflow-hidden rounded-2xl bg-muted bg-cover bg-center"
                ...
                >
                  ...
                  <label
                    ...
                    className="absolute bottom-3 left-3 inline-flex cursor-pointer items-center gap-2 rounded-xl bg-card px-3 py-2 text-xs font-bold text-foreground transition-colors hover:bg-surface-hover"
                  >
              ...
              <label
                htmlFor="featured-image"
                className="group mt-6 flex aspect-[2.4/1] cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border bg-muted text-center transition-colors hover:border-primary/40 hover:bg-primary/[0.03]"
              >
                <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-card text-muted-foreground shadow-sm transition-colors group-hover:text-primary">
        ...
        <aside className="space-y-6">
            ...
            <div className="mt-5 space-y-4">
              <label className="block">
                ...
                <select
                  ...
                  className="mt-2 h-11 w-full cursor-pointer rounded-xl border border-border bg-muted px-3 text-sm outline-none transition-colors hover:border-border-strong hover:bg-card focus:border-primary focus:ring-4 focus:ring-primary/10"
                >
                  <option>News</option>
              ...
              <label className="block">
                ...
                <input
                  ...
                  className="mt-2 h-11 w-full rounded-xl border border-border bg-muted px-3 text-sm outline-none transition-colors placeholder:text-muted-foreground/60 hover:border-border-strong hover:bg-card focus:border-primary focus:ring-4 focus:ring-primary/10"
                />
              ...
              <label className="block">
                ...
                <input
                  ...
                  className="mt-2 h-11 w-full rounded-xl border border-border bg-muted px-3 text-sm outline-none transition-colors hover:border-border-strong hover:bg-card focus:border-primary focus:ring-4 focus:ring-primary/10"
                />
                <p className="mt-1.5 text-xs text-muted-foreground">
          ...
          <section className="space-y-3 rounded-3xl border border-border bg-card p-5 shadow-sm">
            <button
              ...
              value="published"
              disabled={pending}
              className="flex h-11 w-full cursor-pointer items-center justify-center gap-2 rounded-xl bg-primary text-sm font-bold text-white shadow-[0_8px_30px_rgb(46_163_255_/_0.35)] transition-colors hover:bg-primary-hover disabled:cursor-wait disabled:opacity-60"
            >
            ...
            <button
              ...
              value="draft"
              disabled={pending}
              className="flex h-11 w-full cursor-pointer items-center justify-center gap-2 rounded-xl border border-border bg-card text-sm font-bold text-foreground transition-colors hover:border-border-strong hover:bg-surface-hover disabled:cursor-wait disabled:opacity-60"
            >
            ...
            {article ? (
              <button
                ...
                className="flex h-10 w-full cursor-pointer items-center justify-center gap-2 rounded-xl text-sm font-semibold text-muted-foreground transition-colors hover:bg-accent/10 hover:text-accent disabled:cursor-wait disabled:opacity-60"
              >
